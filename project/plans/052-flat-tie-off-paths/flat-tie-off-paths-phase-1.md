...
- [x] Update `execution_test_shared::build_process_strand` — already flat (`/rig/tie-offs/test-loom/k1-tie-off.md`)
- [x] Update `process_strand_deleted_includes_strand_history` — already flat (`/rig/tie-offs/test-loom/k1-tie-off.md`)
